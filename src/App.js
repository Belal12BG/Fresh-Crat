...
import Favouriet from "./Componenets/Favouriet/Favouriet";
import ForgetPassword from "./Componenets/ForgetPassword/ForgetPassword";
import Verify from "./Componenets/Verify/Verify";
import NewPassword from "./Componenets/NewPassword/NewPassword";
  ...
  const routes = createBrowserRouter([
    {
      ...
      children: [
        ...
        { path: "NewPassword", element: <NewPassword></NewPassword> },
        {
          ...
          element: (
            <Suspense>
              <Orders fallback={<Loading></Loading>}></Orders>
            </Suspense>
          ),
        },
        {
